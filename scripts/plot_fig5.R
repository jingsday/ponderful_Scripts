#################################
## Description: Visualisation of dominant landcover across pondscapes
#################################
...
dfqt <- read.csv('phy_che_oct_qt.csv', header=T, sep = ",")
dfall <- read.csv('PhyChe_XY.csv', header=T, sep = ",")
...
write.csv(df,"PhyChe_XY_landcover.csv")
