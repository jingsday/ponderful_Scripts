#################################
## Description: Preprocessing of raw data 
#################################

rm(list=ls())
setwd('PhyChe/Analysis')

#####################################################################################################

Pond <- read.csv('D2.4_PondCharacteristics_20240607.csv', header=T, sep = ",")
id <- read.csv('D2.4_PondID_20240124.csv', header=T, sep = ",")
PC <- read.csv('D2.4_PhysicoChemistry_20240516.csv', header=T, sep = ",")
LU5 <- read.csv('D2.4_LandUse_5m_20240516.csv', header=T, sep = ",")
LC <- read.csv('LandCover_selectedradii.csv', header=T, sep = ",")
A <- read.csv('Animals.csv', header=T, sep = ",")
HA <- read.csv('D2.4_HumanActivity_20240205.csv', header=T, sep = ",")
HP <- read.csv('Hydroperiod_length_data_sampling_resampling.csv', header=T, sep = ",")
ecels <- read.csv('ECELS GEA_2024-03-21.csv', header=T, sep = ",")
climate <- read.csv('Current_climate.csv', header=T, sep = ",")
