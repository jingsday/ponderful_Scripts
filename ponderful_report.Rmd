...
outwdir <- '/Users/lidiayung/PhD_project/project_PONDERFUL/ponderful_Scripts/ponderful_OUTPUT/ponderdul_OUTPUT_publication'
...
#Sum tab
tab_model(TP_glm_euromedi_gamma_selected,
          file = paste0(outwdir, 'tp_euromedi_glm_sum.doc'))
#Predictors 
...
ggsave(filename = paste0(outwdir, 'tp_glm_euromedi_gamma_diagnostics.svg'), 
       plot = diagnostic_plots, 
       width = 10, height = 10, units = "in",dpi = 600)
...
ggsave(filename = paste0(outwdir, 'TN_euromedi_glm_predictors_full.svg'), 
       plot = combined_plot, 
       width = 12, height = 10, units = "in", dpi = 600)
...
ggsave(filename = paste0(outwdir, 'TN_glm_euromedi_gamma_diagnostics.svg'), 
       plot = diagnostic_plots, 
       width = 10, height = 10, units = "in",dpi = 600)
```
...
#sum table
tab_model(TP_temp_linear_model_selected,
          file = paste0(outwdir, 'tp_temp_glm_sum.doc'))
#Visreg predictors
...
ggsave(filename = paste0(outwdir, 'tp_glm_temp_gamma_diagnostics.svg'), 
       plot = diagnostic_plots, 
       width = 10, height = 10, units = "in",dpi = 600)
```
