...
plots_TP <- visreg(TP_full_model, gg = TRUE,partial=TRUE,scale='linear')
visreg(TP_full_model, gg = TRUE,partial=TRUE,scale='response')
...
combined_plot_TP <- wrap_plots(plots_TP_minimal[[1]], 
  plots_TP_minimal[[2]], 
  plots_TP_minimal[[3]],ncol=3,nrow=1,heights = 3)
