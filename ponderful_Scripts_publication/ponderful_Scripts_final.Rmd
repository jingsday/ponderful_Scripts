...
corrplot(cor(model_df[,c('bio1.t','bio7.t','bio5.t','bio12.t','Hydeoperiod_length.T',
                    'Animals_cont.t','Area.t','Depth.t',"Aquatic_500.t",  
                    "Cropland_500.t","Forest_500.t","Pastures.and.open.nature_500.t" ,
                    "Urban_500.t", "Natural_5.t")]), type = "upper", order = "hclust",tl.col = "black", tl.srt = 45 )
#selected vars TN 
round(cor(model_df[,c('bio1.t','bio7.t','bio12.t',
                    'Animals_cont.t','Area.t','Depth.t',"Aquatic_500.t",  
                    "Cropland_500.t","Pastures.and.open.nature_500.t" ,
                    "Urban_500.t", "Natural_5.t")]),2)

corrplot(cor(model_df[,c('bio1.t','bio7.t','bio12.t',
                    'Animals_cont.t','Area.t','Depth.t',"Aquatic_500.t",
                    "Cropland_500.t","Pastures.and.open.nature_500.t" ,
                    "Urban_500.t", "Natural_5.t")]), type = "upper", order = "hclust",tl.col = "black", tl.srt = 45 )
```
...
screen_corr <- function(country, threshold = 0.6) {
  ...
  selected_vars <- df[, c('bio1.t','bio7.t','bio12.t',
                    'Animals_cont.t','Area.t','Depth.t',"Aquatic_500.t",  
                    "Cropland_500.t","Pastures.and.open.nature_500.t" ,
...
high_correlations <- screen_corr(country = "Uruguay")
high_correlations
```
...
tab_model( glm(formula = log_TN ~ Cropland_500.s + Depth.s + 
    bio12.s, data = model_df),transform=NULL,show.intercept = TRUE)

tab_model(glm(formula = log_TN ~ Natural_5.s + Aquatic_500.s + Cropland_500.s + 
    Urban_500.s + Depth.s + bio12.s, data = model_df),transform=NULL,show.intercept = TRUE)

test <-glm(log_TN ~   Cropland_500.s + bio1.s+
    Animals_cont.s + Depth.s + bio7.s + bio12.s,data = model_df)
...
glmfit$delta[2]
tab_model(TN_euromedi_model_selected,transform=NULL,show.intercept = TRUE)
...
```{r TP GLM model}
TP_euromedi_linear_model <- glm(TP ~ Natural_5.s + Aquatic_500.s + Cropland_500.s +
                            Pastures.and.open.nature_500.s +
                             Urban_500.s + Animals_cont.s + Area.s + Depth.s +
...
tab_model(glm(formula = TP ~ Natural_5.s + Cropland_500.s + Pastures.and.open.nature_500.s + 
    Animals_cont.s + Depth.s + bio1.s + bio12.s, family = Gamma(link = "log"), 
    data = model_df),show.intercept = TRUE,transform = NULL)


test <-  glm(formula = TP ~ Natural_5.s + Cropland_500.s + Pastures.and.open.nature_500.s + 
    Animals_cont.s + Depth.s + bio1.s + bio12.s, family = Gamma(link = "log"), 
    data = model_df)
summary(test)
tab_model(test,show.intercept = TRUE,transform = NULL)
...
glmfit <- cv.glm(data = model_df, glmfit = glm(formula = TP ~ Natural_5.s + Cropland_500.s + Pastures.and.open.nature_500.s + 
    Animals_cont.s + Depth.s + bio1.s + bio12.s, family = Gamma(link = "log"), 
    data = model_df),K = 5)
glmfit$delta[2]
...
tp_glm_analysis <- function(country, K) {
  ...
  initial_model <- glm(formula = TP~ Natural_5.s + Aquatic_500.s + Cropland_500.s +
                            Pastures.and.open.nature_500.s +
                             Urban_500.s + Animals_cont.s +  Depth.s +
                          bio7.t, #bio1.s+bio7.t+bio12.s+Area.s +
...
tp_belgium_sig_model <- glm(formula = TP ~ Aquatic_500.s + Urban_500.s + Animals_cont.s + 
    Depth.s + bio1.s, family = Gamma(link = "log"), data = model_df[model_df$Country=='Belgium',])
...
cv.glm(glm(formula = TP ~ Animals_cont.s + bio1.s + Cropland_500.s + 
    Natural_5.s, family = Gamma(link = "log")),)
...
test <- glm(formula = TP ~    Cropland_500.s , family = Gamma(link = "log"), 
    data = df)
tab_model(test,transform = NULL,show.intercept = TRUE)
...
tn_glm_analysis <- function(country, K) {
  ...
  # Step 2: Fit the initial GLM model
  initial_model <- glm(formula = log_TN~ Natural_5.s + Aquatic_500.s + Cropland_500.s +
                            Pastures.and.open.nature_500.s +
                             Urban_500.s + Animals_cont.s + Area.s + Depth.s +
                             bio1.s+bio7.t+bio12.s, 
                       data = df)
