...
step(TP_full_model)
TP_full_model<-  glm(formula = TP ~ Natural_5.s + Cropland_500.s + Pastures.and.open.nature_500.s + 
...
plots_TN <- visreg(TP_full_model, gg = TRUE,)
...
```{r}
#Variables set
# Natural_5.s + Aquatic_500.s + Cropland_500.s +
#                             Pastures.and.open.nature_500.s +
#                              Urban_500.s + Animals_cont.s + Area.s + Depth.s +
#                              bio1.s+bio7.t+bio12.s
tp_glm_analysis <- function(country, K) {
  ...
  initial_model <- glm(formula = TP~ Natural_5.s + Aquatic_500.s + 
                            Pastures.and.open.nature_500.s +
                             Urban_500.s + Animals_cont.s + Area.s + Depth.s +
                             bio1.t,
...
# log_TN~ Natural_5.s + Aquatic_500.s + Cropland_500.s +
#                             Pastures.and.open.nature_500.s +
#                              Urban_500.s + Animals_cont.s + Area.s + Depth.s +
#                              bio1.s+bio7.t+bio12.s, 
...
tn_glm_analysis <- function(country, K) {
  ...
  initial_model <- glm(formula = log_TN~ Natural_5.s + Aquatic_500.s + Cropland_500.s +
                             Urban_500.s + Animals_cont.s + Area.s + Depth.s + bio1.s+bio12.s,
                       data = df)
