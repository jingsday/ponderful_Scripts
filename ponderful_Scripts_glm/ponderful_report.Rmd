...
tp_mixed_euromedi_linear_model <-glmer(formula = TP ~ Cropland_500_qt +
                                        ...
                                        Animals_cont.t + Depth.t + bio1.t, family = Gamma(link = "log"), data = df)
tab_model(tp_mixed_euromedi_linear_model,file=paste0(outwdir,'tp_mixed_euromedi_linear_model.doc'))
...
model <- glmer(TP ~ Cropland_500_qt+ bio1.t + Pastures.and.open.nature_500_qt +
                 Animals_cont.t + Depth.t + (1 + Cropland_500_qt | Country),  data = df,  family = Gamma(link = "log"))
summary(model)
tab_model(model)
...
png("TN_Country_intercepts.png", height = 7, width = 5, units = "in", res = 300)
