...
TP_gam_medi <- gam(TP ~ s(Natural_5_qt,k=9) + s(Aquatic_500_qt,k=6) + 
                     s(Cropland_500_qt) +
                     s(Pastures.and.open.nature_500_qt) + s(Urban_500_qt) +
...
TP_gam_medi_selected<-gam(TP ~ s(Natural_5_qt) + s(Aquatic_500_qt) + 
                           s(Cropland_500_qt) +
                           s(Pastures.and.open.nature_500_qt) + s(Depth.t),  
                         data = df, family = Gamma(link = "log"))
...
TP_gam_ctn <- gam(TP ~ s(Natural_5_qt) + s(Forest_500_qt)+s(Cropland_500_qt) +
                    s(Urban_500_qt) + s(Depth.t)+ s(bio7.t,k=5),  
                   data = df, family = Gamma(link = "log"))
...
TP_gam_temp <- gam(TP ~ s(Natural_5_qt) + s(Aquatic_500_qt) + 
                     s(Cropland_500_qt) +
                     s(Pastures.and.open.nature_500_qt) + s(Urban_500_qt) +
                     s(Animals_cont.t, k = 5) + s(Depth.t)+ s(bio5.t)+s(bio1.t),  
                   data = df, family = Gamma(link = "log"))
summary(TP_gam_temp)
...
df <-model_TN_df[model_TN_df$bioregion == input,][,c('TN','Natural_5_qt',  'Cropland_500_qt', 'Urban_500_qt',  'Depth.t', 
                                                     'Forest_500_qt','bio7.t')]  
hist(df$TN)
TN_gam_ctn <-gam(TN ~ s(Natural_5_qt,k=9) + s(Forest_500_qt)+
...
df <-model_TN_df[model_TN_df$bioregion == input,][,c('TN','Natural_5_qt',  'Cropland_500_qt', 
                                                     ...
                                                     'Pastures.and.open.nature_500_qt', 'Aquatic_500_qt','Animals_cont.t', 'bio5.t')]
hist(df$TN)
